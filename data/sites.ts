...
export const sites: Site[] = [
  {
    ...
    history:
      "**The sea that built the city.** The Coromandel coast is a sailor's nightmare: flat, featureless, deadly surf, no natural harbour. Ships anchored offshore and goods came to shore by small boat through breaking waves. The French never solved the harbour problem, but they gave Pondicherry a face: a seafront grand enough to make visitors forget there was no port behind it.\n\n**The monuments, north to south.** Named after Mayor [Édouard Goubert](/history/lives-and-legacies/edouard-goubert), the Promenade is an accidental open-air museum. Walking south: the [French War Memorial](/discover/landmarks/war-memorial) (still tended by the [French Consulate](/history/institutions/consulate-general) today); the Jeanne d'Arc memorial park; the [Dupleix statue](/discover/landmarks/dupleix-statue) (the man who nearly made France master of India); the [Gandhi statue](/discover/landmarks/gandhi-statue) (the man who made Britain leave); the circular Douane, the old Customs House, built in 1827 at the height of Pondicherry's Restoration-era rebuild. [Notre-Dame des Anges](/discover/landmarks/notre-dame) isn't on the Promenade but you can see its twin towers from here.\n\n**The sea wall.** The low granite parapet running along the seafront isn't just a barrier. It's the city's communal sitting place. Pondicherrians have been perching on it at dusk for centuries.\n\n**New Year's Eve.** This is where the city gathers to count down on [New Year's Eve](/festivals/new-year), alongside the lanes of the White Town just behind it.",
    highlights: [
  ...
  },
  {
    ...
    history:
      "**Four churches, one site.** The Capuchins built the first chapel here in 1707, a year after [François Martin](/history/lives-and-legacies/francois-martin)'s death. A second was built 1739–1758 under Governors Dumas and [Dupleix](/history/lives-and-legacies/dupleix), then razed by the British in 1761. A third went up 1765–1770; its square bell-tower and nave were absorbed into the current building. The fourth and present church was built 1851–1855 by engineer Louis Guerre (1800–1865), whose family had lived in Pondicherry since the 18th century. Tamil residents still call the site Capus Koil ('Capuchin Church' in Tamil phonetics), honouring the order that started it all in 1674.\n\n**The engineer.** Louis Guerre also built the lighthouse and many of the finest residences in the neighbourhood. The church sits atop a substructure, reached by two symmetric staircases of a dozen steps each, and measures 55 by 35 metres. Its dome (polygonal, above the crossing) diffuses soft light through eight latticed windows in blue, yellow, and red over the high altar. That altar, white marble with grey veins, was gifted by [François Gaudart](/history/lives-and-legacies/francois-gaudart); it carries a low-relief of the Last Supper in wrought brass.\n\n**Joan of Arc.** Opposite the church, where the promenade meets Rue Dumas, lies a small garden. At its centre: a marble Joan of Arc, armoured, carrying a battle standard, installed in April 1923, donated by [François Gaudart](/history/lives-and-legacies/francois-gaudart), politician and industrialist. Joan expelled the English from France; the English had razed this church in 1761. Under Governor [Charles Baron](/history/lives-and-legacies/charles-baron) during the Second World War, the annual feast became a Gaullist commemoration: Free France rallying around a medieval French warrior-saint, in a colonial church, on the Bay of Bengal.\n\n**Christmas and Easter.** This is one of three churches that hold a candlelit vigil at [Christmas](/festivals/christmas) and [Easter](/festivals/easter). At midnight, every light in the building goes dark and the congregation lights candles together.",
    highlights: [
      ...
      "The Joan of Arc garden sits opposite the church, across Rue Dumas: the statue faces the church, her back to the Bay of Bengal.",
    ],
    visitInfo: {
  ...
  },
  {
    ...
    highlights: [
      ...
      "Names include Captain François Marius Xavier of Reddiarpalayam and Victor Simonel, both with streets in the White Town",
    ],
  ...
  },
  {
    ...
    visitInfo: {
      ...
      entry: "Free",
      tip: "Best light is early morning with the sun behind you from the sea side. The Gandhi statue stands well to the north, near the Raj Nivas end of the promenade, not adjacent to this one: two men from different centuries who each changed India's fate, sharing the same boulevard but not the same stretch of it.",
    },
  },
  {
    id: "gandhi-statue",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Faces Notre-Dame des Anges across Rue Dumas, in a garden bordered by the promenade and the street, not attached to the church itself.",
    ...
    visitInfo: {
      ...
      entry: "Free",
      tip: "Come in the morning for softer light, and there is a good chance you will find a game of pétanque in progress under Joan of Arc.",
    },
  },
  {
    id: "schoelcher-bust",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Rue Victor Simonel is itself named for a colonial official killed at Verdun in WWI.",
    ],
  ...
  },
  {
    ...
    history:
      "**Where to begin.** Start at the Institut Français de Pondichéry on [Rue Dumas](/discover/white-town/rue-dumas), the large orange building that announces itself before you can read the sign. That colour is deliberate: French institutional architecture had a habit of stating its presence in warm, saturated ochre, and this building, one of the few active French research centres in India, is a reminder that French Pondicherry did not end with decolonisation. It continued as scholarship. The Institut publishes the finest heritage map of White Town; ask at the reception before you set off.\n\n**The seafront and its monuments.** Walk east to [Goubert Avenue](/discover/white-town/avenue-goubert), the promenade that faces the Bay of Bengal. The [French War Memorial](/discover/landmarks/war-memorial) stands here, tended still by the [French Consulate](/history/institutions/consulate-general), dedicated to the residents of French India who died for France in the First World War: Tamil soldiers who fought at Verdun and Gallipoli under a tricolour they may never have seen before they sailed. Across the road, the Mahatma Gandhi Statue stands within a ring of granite pillars, a white structure facing the sea, on the same avenue where French governors once processed in ceremony. A short walk south, the statue of [Joseph François Dupleix](/history/lives-and-legacies/dupleix) faces the water: the man who governed Pondicherry from 1742 to 1754 and nearly made France the dominant power in India. He was recalled by his own company, died broke in Paris, still fighting his creditors. His statue outlasted the empire he built.\n\n**Joan of Arc, in the tropics.** In a small garden opposite Notre-Dame des Anges, where Rue Dumas meets the seafront, stands a marble Joan of Arc, armoured, carrying a battle standard, donated by French politicians and businessmen in April 1923. She expelled the English from France. The British had razed this very city to the ground in 1761. The choice of subject was not accidental.\n\n**Le Café, at any hour.** On the promenade, Le Café is the oldest French cafe in Pondicherry, open twenty-four hours a day, a fact which becomes useful if you arrive before dawn to walk the seafront as the fishermen haul in their nets. Sit facing the sea, order coffee, and watch the bay go from black to grey to gold. By the time your cup is empty, the city will have woken up around you.\n\n**The church of three languages.** [Notre-Dame des Anges](/discover/landmarks/notre-dame), whose twin cream towers you can see from the promenade, has stood on this seafront site since 1687, rebuilt four times, and consecrated in its present form in 1855. It is the only church in Pondicherry where Mass is celebrated in Tamil, English, and French, the three languages of the city's three centuries. Twenty-eight stained-glass windows were shipped from France and installed in a building made of local coral stone. Morning Mass begins at 5:30am. The gates close at 8:00pm. The marble Joan of Arc in the garden outside faces the church itself, across the street.\n\n**The scholars who stayed.** Walk back into the grid and you find the intellectual institutions that are, arguably, the most enduring thing France left in Pondicherry. The [École française d'Extrême-Orient](/history/institutions/efeo), known universally as EFEO, founded in Hanoi in 1900 and present in Pondicherry since 1955, is dedicated to the study of Asian civilisations. Its scholars have documented temples, inscriptions, and manuscripts across India, Southeast Asia, and East Asia. UNESCO has recognised its work on Indian art, architecture, and literature. This is not a colonial archive gathering dust; it is an ongoing centre of living scholarship. The [Alliance Française de Pondichéry](/history/institutions/alliance-francaise), a short walk away, runs language courses and cultural programmes that have been the city's French cultural hub for decades. These are not monuments to a departed empire. They are working institutions.\n\n**The oldest church in the quarter.** The Immaculate Conception Cathedral, known locally as Samba Kovil (Tamil for Saint's Church), is one of the oldest churches in Pondicherry. Its plainer, more austere character reflects the earlier French presence: before the stained glass and the twin towers, before the grand civic ambitions of the nineteenth century. The walls carry more history than the signage admits. Walk past slowly.\n\n**The man who wrote the constitution.** The B.R. Ambedkar Mani Mandabam stands as a tribute to Dr. B.R. Ambedkar, the jurist, economist, and social reformer who drafted the Constitution of India. It is fitting that a city whose identity rests on the coexistence of the French, the Tamil, and the Indian should dedicate a building to the man who gave India its constitutional framework for equality. He would have understood this city.\n\n**The Lycée.** The [Lycée Français International de Pondichéry](/history/institutions/lycee-francais) educates children from the age of three to eighteen in the French national curriculum, the only such school in South India. French families, Tamil families, and international residents send their children here. The school is a living reminder that French Pondicherry is not purely a historical subject. It is a present one.\n\n**The park that was Napoleon's square.** [Bharathi Park](/discover/landmarks/bharathi-park) is the ceremonial heart of White Town: the open square surrounded by [Raj Nivas](/discover/landmarks/raj-nivas) to the north (the Lieutenant Governor's official residence, once the palace of the French Governor), the Legislative Assembly, the Secretariat, and the [Puducherry Museum](/discover/landmarks/museum). At its centre stands the Aayi Mandapam, four Greco-Roman columns under a domed roof, built under Napoleon III to honour a Tamil woman named Aayi who demolished her own house to provide water for the city, centuries before the French arrived. European stone, Indian legend. The park is open from 6:00am to 8:00pm. Entry is free. Sit on a bench in the morning and watch the city go through its routines: joggers, vendors, schoolchildren, retirees reading newspapers in the shade of mango trees.\n\n**The museum that rewards slowness.** The [Puducherry Museum](/discover/landmarks/museum), at the north-east corner of Bharathi Park, holds 81 Chola bronze sculptures of international calibre, Roman pottery imported from Italy two thousand years ago, Franco-Tamil colonial furniture, and a vehicle that the poet [Subramania Bharathi](/history/lives-and-legacies/subramania-bharati) is said to have loved. It costs ten rupees to enter and rewards ninety minutes of unhurried attention. Open 10:00am to 5:00pm. The bronze gallery alone is worth the walk.\n\n**After the tour.** The streets of White Town are at their best before 10am: soft light, cool air, shutters just opening, the smell of jasmine over coral-stone walls. When the heat builds, the quarter's deep verandahs and tall-ceilinged heritage cafes offer shade and strong coffee. Take any random turn off the main route and you will find beauty in every direction. Nowhere else in India does a town like this survive so intact, so alive, and so quietly magnificent.",
    highlights: [

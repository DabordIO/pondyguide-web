...
export const sitesFr: SiteFr[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Parmi les noms : le capitaine François Marius Xavier de Reddiarpalayam et Victor Simonnel, tous deux honorés par une rue du quartier français",
    ],
    visitInfo: {
  ...
  },
  {
    ...
    visitInfo: {
      ...
      entry: "Gratuit",
      tip: "La meilleure lumière est tôt le matin, avec le soleil derrière vous du côté de la mer. Marchez 50 m vers le sud et vous atteindrez la statue de Gandhi : deux hommes de siècles différents qui changèrent chacun le destin de l'Inde, partageant le même boulevard.",
    },
  },
  {
    id: "gandhi-statue",

...
export const sitesFr: SiteFr[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Le jardin de Jeanne d'Arc, en face de l'église, de l'autre côté de la rue Dumas : la statue fait face à l'église, dos tourné à la baie du Bengale.",
    ],
    visitInfo: {
  ...
  },
  {
    ...
    highlights: [
      ...
      "Fait face à Notre-Dame des Anges de l'autre côté de la rue Dumas, dans un jardin bordé par la promenade et la rue, non accolé à l'église elle-même.",
    ...
    visitInfo: {
      ...
      entry: "Gratuit",
      tip: "Venez le matin pour une lumière plus douce, et vous avez de bonnes chances de trouver une partie de pétanque en cours sous Jeanne d'Arc.",
    },
  },
  {
    id: "schoelcher-bust",

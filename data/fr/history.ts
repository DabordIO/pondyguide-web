...
Si l'on sait où regarder, cet ashram se dressait sur le même sol où se trouve aujourd'hui l'[ashram de Sri Aurobindo](/discover/landmarks/ashram). C'est un détail qui demande un instant pour être pleinement saisi : la continuité d'une géographie sacrée à travers trois mille ans d'habitation humaine.
...
C'est peut-être la chose la plus intéressante à propos de Pondichéry. Elle a absorbé les Romains et les Pallava, les Chola et les Moghols, les Français et les Britanniques, l'ashram et la commune. Elle demeure reconnaissablement elle-même. La mer que les marchands romains traversaient pour l'atteindre est la même mer que l'on peut voir aujourd'hui depuis la promenade. La continuité, c'est la ville.`,
  },
  {
    ...
    body: `Sur l'[avenue Goubert](/discover/white-town/avenue-goubert), la promenade du front de mer qui longe la bordure de l'ancien quartier français de Pondichéry, se dresse un [monument aux morts](/discover/landmarks/war-memorial). Il fut inauguré le 3 avril 1938, face au golfe du Bengale. Son inscription recense les noms des hommes des Cinq Comptoirs de l'Inde française (Pondichéry, Karikal, Mahé, Yanaon et Chandernagor) morts au service de la France.
...
Ce qui distingue Pondichéry n'est pas une voie juridique particulière, mais une population historique spécifique. Certaines familles de cette ville détiennent la nationalité française depuis trois ou quatre générations, transmise depuis l'ère des renonçants. Ce sont des citoyens français vivant en Inde, desservis par le [Consulat général](/fr/history/institutions/consulate-general) de la rue de la Caserne, commémorés au [monument aux morts](/discover/landmarks/war-memorial) de l'avenue Goubert.

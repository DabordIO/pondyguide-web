export interface HistoryArticleFr {
  id: string;
  title: string;
  metaTitle?: string;
...
export const historyArticlesFr: HistoryArticleFr[] = [
  {
    ...
    title: "Avant les Français",
    metaTitle: "Avant les Français : Rome et la Pondichéry antique",
    metaDescription: "Bien avant la domination européenne, cette côte commerçait avec Rome, figurait dans la poésie tamoule et accueillait des pèlerins.",
    subtitle: "Deux mille ans d'un rivage de renommée mondiale",
    teaser: "Bien avant qu'aucun drapeau européen ne flotte ici, cette côte était déjà cosmopolite. Les Romains y mouillaient. Les poètes tamouls en chantaient les louanges. Les pèlerins en arpentaient les routes depuis des siècles.",
    body: `Deux mille ans avant qu'un Français ne pose le pied sur ce rivage, les marchands de Rome savaient exactement où le trouver.
...
Si l'on sait où regarder, cet ashram se dressait sur le même sol où se trouve aujourd'hui l'[ashram de Sri Aurobindo](/fr/discover/landmarks/ashram). C'est un détail qui demande un instant pour être pleinement saisi : la continuité d'une géographie sacrée à travers trois mille ans d'habitation humaine.
...
Le plan en damier qu'il traça, le canal qui séparait le quartier tamoul du quartier français, les noms de rues qui subsistent encore aujourd'hui : tout cela fut imposé à un paysage déjà chargé d'histoire. Les Français arrivaient tard à une très vieille fête. Ce qu'ils choisirent de faire de leur invitation est l'histoire qui suit.`,
  },
  {
    ...
    title: "L'arrivée des Européens",
    metaTitle: "Comment les Européens arrivèrent à Pondichéry",
    metaDescription: "Cinq puissances européennes se disputèrent la côte de Coromandel, mais il fallut un siècle pour donner sa forme à Pondichéry.",
    subtitle: "Portugais, Danois, Hollandais, Britanniques. Et enfin les Français.",
    teaser: "Cinq puissances européennes tentèrent de s'implanter sur la côte de Coromandel. Une seule réussit à bâtir quelque chose de durable. Mais il fallut un siècle, neuf hommes, et un plan de rues rectilignes pour y parvenir.",
    body: `Les Européens qui transformèrent cette côte n'arrivèrent pas tous en même temps. Ils vinrent sur deux siècles, chaque vague se construisant sur les ruines de la précédente.
...
C'est la longue rivalité entre la Pondichéry française et la Madras britannique qui allait définir l'histoire de la côte de Coromandel pour le siècle suivant. Les Portugais avaient essayé et laissé leur foi. Les Danois avaient essayé et laissé leur presse d'imprimerie. Les Hollandais avaient essayé et calculé que le profit était ailleurs. Il en restait deux, se faisant face sur la même étroite bande de côte. Leur rivalité serait tranchée non par le commerce, mais par les ambitions d'un seul gouverneur extraordinaire, arrivé à Pondichéry en 1742, convaincu qu'il pouvait changer les règles du jeu.`,
  ...
  {
    id: "dupleix-gamble",
    title: "Le pari de Dupleix",
    metaTitle: "Le pari de Dupleix et l'Inde française",
    metaDescription: "En 1742, Dupleix arriva avec une vision radicale : la France dominerait le Deccan autant par la politique que par le commerce.",
    subtitle: "L'homme qui faillit offrir un empire à la France",
    teaser: "En 1742, un nouveau gouverneur arriva à Pondichéry avec une idée audacieuse : la France pouvait dominer le Deccan non par le commerce, mais par le génie politique. Pendant une décennie, il eut presque raison.",
    body: `Le matin du 15 janvier 1742, Joseph François Dupleix débarqua à Pondichéry sous le tonnerre de vingt et un coups de canon. Il avait déjà décidé quel genre de gouverneur il entendait être. La Compagnie des Indes l'avait envoyé diriger un comptoir commercial. Il entendait bâtir un empire.
...
Le moment décisif survint en 1749, quand des querelles de succession éclatèrent simultanément à Hyderabad et dans le Carnatic. Dupleix soutint deux prétendants : Muzaffar Jang pour le trône d'Hyderabad, [Chanda Sahib](/fr/history/lives-and-legacies/chanda-sahib) pour le nawabat du Carnatic. Une force conjointe franco-indienne balaya le terrain. Le nawab du Carnatic fut tué au combat. Le nouveau nizam vint en personne à Pondichéry reconnaître son protecteur.
...
L'instrument du renversement français fut un ancien comptable nommé [Robert Clive](/fr/history/lives-and-legacies/robert-clive). Là où Dupleix avait bâti des coalitions par le cérémonial et les subsides, Clive agissait vite, frappait fort, et choisissait ses moments avec l'instinct d'un homme qui connaissait le jeu de son adversaire.

La chute survint à Srirangam en juin 1752. Le commandant français [Law de Lauriston](/fr/history/lives-and-legacies/law-de-lauriston), encerclé sur une île du fleuve Kaveri, rendit sa force. Chanda Sahib fut fait prisonnier par les hommes d'un rival et décapité la même après-midi. Le protectorat du Carnatic n'existait plus.
...
Le jardin qu'il avait planté était Pondichéry elle-même, brièvement capitale d'un empire français qui faillit exister. Parcourez ces rues, suivez du regard les noms gravés dans la pierre au-dessus de votre tête, et vous marchez à travers ce qui reste de son pari.`,
  ...
  {
    id: "the-fallen-city",
    title: "La ville tombée",
    metaTitle: "Le siège britannique de Pondichéry en 1761",
    metaDescription: "Après la prise de Pondichéry par les Britanniques en 1761, la ville fut rasée puis reconstruite lentement par les Français.",
    subtitle: "Siège, démolition, et la longue reconstruction",
    teaser: "En 1761, les Britanniques s'emparèrent de Pondichéry et la démolirent systématiquement. Ce que les Français récupérèrent huit ans plus tard n'était qu'un champ de ruines. La ville que vous voyez aujourd'hui fut bâtie sur cette fondation, pierre après patiente pierre.",
    body: `En 1758, alors que le grand projet de Dupleix se défaisait déjà, la France envoya un nouveau commandant pour sauver sa position en Inde. Thomas Arthur, comte de Lally, arriva à Pondichéry ce printemps-là, plein d'énergie, et se fit rapidement des ennemis de tous ceux qui l'entouraient.
...
En 1910, un philosophe, poète et ancien révolutionnaire bengali nommé [Aurobindo Ghosh](/fr/history/lives-and-legacies/sri-aurobindo) franchit la frontière de l'Inde britannique vers la Pondichéry française. Il était sous surveillance britannique en tant qu'agitateur politique, et la juridiction française offrait un cadre légal différent. Il n'avait aucune intention de repartir.
...
La ville où il arriva était tranquille et consciente de son statut diminué. Ses rues portaient encore les noms de gouverneurs français, d'amiraux, de batailles. Son canal séparait encore le quartier tamoul du quartier français. Mais l'énergie qui en avait fait une capitale avait depuis longtemps disparu. Ce qui restait, c'était le damier, les pierres, la digue, et une qualité particulière de lumière en fin d'après-midi qui n'a rien à voir avec la politique et tout à voir avec l'endroit où l'on se trouve sur la terre.`,
  },
  {
    ...
    title: "1954 : la passation",
    metaTitle: "1954 : la fin de l'Inde française à Pondichéry",
    metaDescription: "L'Inde devint indépendante en 1947, mais Pondichéry resta française encore sept ans avant un transfert ordonné et partiel.",
    subtitle: "La fin pacifique de trois siècles de domination française",
    teaser: "L'Inde devint indépendante en 1947. Pas Pondichéry. Pendant sept années encore, le tricolore flotta sur le quartier français pendant que le reste du pays se refaisait. Quand le transfert vint enfin, il fut ordonné, et soigneusement incomplet.",
    body: `L'Inde devint indépendante le 15 août 1947. Pas Pondichéry.
...
Le tournant politique décisif survint en mars 1954, quand [Édouard Goubert](/fr/history/lives-and-legacies/edouard-goubert), qui avait été l'architecte de la position électorale pro-française en 1948 et la principale voix locale en faveur du maintien français, se rallia au camp indien. Son revirement leva le principal obstacle politique local au transfert. En octobre 1954, le *Congrès de Kizhoor*, l'assemblée délibérative sur la question de la fusion, vota par 170 voix contre 8 en faveur. La logique de la situation était devenue impossible à nier.
...
C'est peut-être la chose la plus intéressante à propos de Pondichéry. Elle a absorbé les Romains et les Pallava, les Chola et les Moghols, les Français et les Britanniques, l'ashram et la commune. Elle demeure reconnaissablement elle-même. La mer que les marchands romains traversaient pour l'atteindre est la même mer que l'on peut voir aujourd'hui depuis la promenade. La continuité, c'est la ville.`,
  ...
  {
    id: "two-independence-days",
    title: "Deux jours de l'indépendance",
    metaTitle: "Pourquoi Pondichéry a-t-elle deux jours de l'indépendance ?",
    metaDescription: "Pondichéry célèbre la liberté à trois dates, pas une seule : le 15 août, le 1er novembre 1954 et le 16 août 1962. Une histoire d'élection truquée, de retournement politique et de Diên Biên Phu.",
    subtitle: "Une élection truquée, un retournement de veste, et une échéance à Genève",
    teaser:
...
Quand des officiels français passent par Pondichéry, c'est là qu'ils viennent. Il fait face à la mer d'où plus aucune flotte française n'arrivera jamais. Les noms y sont toujours. Le Consulat y dépose ses gerbes. Et dans une ville où trois siècles de présence française ont été absorbés et rendus largement, paisiblement indiens, ce coin de l'avenue Goubert a été conservé, spécifiquement et délibérément, comme appartenant à la France.`,
  },
  {
    ...
    title: "Un habitant de Pondy peut-il devenir français ?",
    metaTitle: "Le système des renonçants à Pondichéry",
    metaDescription: "Dans la Pondichéry coloniale, tout le monde ne pouvait pas devenir français. Ce système juridique a façonné la société de la ville.",
    subtitle: "Le système des renonçants, l'option de 1962, et ce qu'il en reste aujourd'hui",
    teaser: "La réponse courte est : non, plus de la façon dont c'était autrefois possible. Mais la façon dont c'était autrefois possible est l'une des inventions juridiques les plus étranges de l'ère coloniale, et la comprendre explique pourquoi Pondichéry a le visage qu'elle a.",
    body: `Du milieu du XIXe siècle jusqu'au transfert de 1962, l'Inde française fit fonctionner une porte juridique que l'Inde britannique n'a jamais eue : un moyen pour un résident indien de sortir formellement du statut personnel hindou ou musulman et d'entrer dans la pleine citoyenneté française, sans quitter son foyer ni se convertir à quoi que ce soit. Cela produisit une classe de familles françaises en tout point de droit et tamoules en tout point de culture, et leurs descendants font toujours partie de Pondichéry aujourd'hui.
...
Ce qui distingue Pondichéry n'est pas une voie juridique particulière, mais une population historique spécifique. Certaines familles de cette ville détiennent la nationalité française depuis trois ou quatre générations, transmise depuis l'ère des renonçants. Ce sont des citoyens français vivant en Inde, desservis par le [Consulat général](/fr/history/institutions/consulate-general) de la rue de la Caserne, commémorés au [monument aux morts](/fr/discover/landmarks/war-memorial) de l'avenue Goubert.

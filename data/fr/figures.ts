...
Sa méthode est audacieuse et, un temps, redoutablement efficace. Quand le nizam d'Hyderabad meurt en 1748 et que des crises de succession éclatent simultanément à Hyderabad et dans le Carnatic, il agit vite. Il soutient [Chanda Sahib](/fr/history/lives-and-legacies/chanda-sahib) pour le nawabat du Carnatic, installe à Hyderabad un nizam ami grâce à son brillant commandant de terrain [Bussy](/fr/history/lives-and-legacies/charles-de-bussy), et revendique à son apogée une souveraineté indirecte sur un territoire plus vaste que la France elle-même. Le mécanisme n'est pas la conquête à l'européenne mais le patronage stratégique : des cipayes formés à la française, postés dans les cours clés, comme garantie silencieuse derrière les trônes indiens.
...
Sa statue se dresse sur l'[avenue Goubert](/fr/discover/white-town/avenue-goubert), le bras levé vers la mer. La [rue Dupleix](/fr/discover/white-town/rue-dupleix) traverse le cœur de la Ville Blanche. La ville qu'il gouverna porte encore son nom sur l'une de ses plus anciennes rues, et la logique de son expérience, la politique locale plutôt que la conquête directe, sera réinventée, sous une forme très différente, par les Britanniques au siècle suivant.`,
  },
...
À la bataille d'Ambur, le 3 août 1749, une force combinée franco-mysorienne défit et tua Anwaruddin Khan, le nawab en titre. Chanda Sahib fut proclamé nawab du Carnatic. Il récompensa généreusement les Français : il nomma [Dupleix](/fr/history/lives-and-legacies/dupleix) commandant de ses armées, céda à la France le village de [Villianur](/festivals/villianur-car-festival), et confirma la possession française de Karikal. Son rival soutenu par les Britanniques, Muhammad Ali, se replia sur la forteresse rocheuse de Trichinopoly, qui devint le noyau de la résistance.

La riposte britannique fut la prise d'Arcot par Robert Clive en 1751, qui détourna les forces de Chanda Sahib du siège crucial de Trichinopoly. Les campagnes de 1751 et 1752 tournèrent régulièrement au désavantage de l'alliance française. Le 12 juin 1752, la même après-midi où la force française commandée par [Law de Lauriston](/fr/history/lives-and-legacies/law-de-lauriston) capitulait à Srirangam, Chanda Sahib fut capturé par les soldats de l'armée de Tanjore et décapité. Sa mort mit fin, en une seule après-midi catastrophique, à la construction politique la plus ambitieuse de Dupleix.`,
  },

  {
    ...
    dates: "1718–1785",
    role: "Commandant militaire français dans le Deccan",
    metaTitle: "Charles de Bussy, le lieutenant de Dupleix à Hyderabad",
    metaDescription: "Bussy gouverna un protectorat français à Hyderabad pendant huit ans avec une poignée d'hommes, jusqu'à ce que son rappel ne détruise le système qu'il avait bâti.",
    teaser: "L'officier le plus doué de Dupleix, qui administra un protectorat français à Hyderabad pendant huit ans avec à peine deux mille hommes, et dont le rappel détruisit tout ce qu'il avait construit.",
    body: `**HUIT ANS À HYDERABAD**
...
Il est capturé à la bataille de Wandiwash en janvier 1760 et passe trois ans comme prisonnier des Britanniques. Il rentre en France, traverse les années de paix, puis repart en 1782 pour l'Inde à la tête d'une expédition française pendant la guerre d'indépendance américaine — pour arriver à Pondichéry, à soixante-quatre ans, alors que la paix est déjà conclue. Il meurt à Pondichéry le 7 janvier 1785, dans une ville désormais réduite à un simple comptoir commercial, bien loin de la cour d'Hyderabad où il avait passé les plus belles années de sa carrière. La [rue Bussy](/fr/discover/white-town/rue-bussy), l'une des principales artères de la Ville Blanche, porte son nom.`,
...

  {
    ...
    dates: "1702–1766",
    role: "Dernier commandant français de Pondichéry",
    metaTitle: "Le comte de Lally, le général qui perdit l'Inde française",
    metaDescription: "Arrivé en 1758 pour sauver l'Inde française, Lally présida au contraire à son effondrement et fut exécuté à Paris pour cette défaite.",
    teaser: "Le général irlando-français arrivé en 1758 pour sauver l'Inde française, qui présida au contraire à son effondrement final, avant d'être exécuté à Paris pour une défaite qui était, structurellement, inévitable.",
    body: `**LE DERNIER COMMANDANT**
...
Sa prise d'Arcot en septembre 1751, avec deux cents hommes, constitue le pivot stratégique de la deuxième guerre du Carnatic. En s'emparant d'Arcot, siège traditionnel des nawabs du Carnatic, Clive contraint [Chanda Sahib](/fr/history/lives-and-legacies/chanda-sahib) à détourner des forces du siège crucial de Trichinopoly, où Muhammad Ali, soutenu par les Britanniques, tenait bon. Il conserve ensuite Arcot pendant cinquante jours face à une force assiégeante bien supérieure en nombre, repoussant un assaut majeur dans la nuit du Muharram, le 14 novembre 1751. L'effet moral fut durable : il démontrait que des troupes indiennes commandées par les Britanniques pouvaient tenir des positions fortifiées face à des forces alliées aux Français bien plus nombreuses. À Srirangam, en juin 1752, il encercle la force française commandée par [Law de Lauriston](/fr/history/lives-and-legacies/law-de-lauriston) et la contraint à capituler la même après-midi où [Chanda Sahib](/fr/history/lives-and-legacies/chanda-sahib) est décapité. Le protectorat de Dupleix touchait à sa fin.
...
Il meurt le 7 décembre 1782 d'un abcès lombaire, au moment même où l'engagement stratégique français auprès de Mysore atteignait son sommet. L'un de ses derniers officiers français, un capitaine nommé Bouthenot, écrivit : *« Ce grand homme avait de l'estime pour notre nation. »* Son fils [Tipu Sultan](/fr/history/lives-and-legacies/tipu-sultan) hérita du trône, de l'armée et de l'alliance française. La [rue Hyder Ali](/fr/discover/white-town/hyder-ali-street), dans la Ville Blanche, porte aujourd'hui son nom.`,
  },
...
Tipu Sultan, né Fateh Ali Sahab Tipu en 1751 près de Bangalore, hérite de son père [Hyder Ali](/fr/history/lives-and-legacies/hyder-ali) non seulement le royaume de Mysore, mais aussi un cadre stratégique : la résistance systématique à l'expansion britannique par l'alliance avec la France. Ce que Tipu y ajouta, c'est l'intensité idéologique. Il ne se contenta pas de s'allier à la France comme partenaire militaire. Il s'aligna sur la France comme sur un idéal révolutionnaire.
...
Parmi les objets que les Britanniques emportèrent de son palais figurait un automate mécanique grandeur nature : un tigre mutilant un soldat européen, équipé d'un orgue reproduisant le rugissement du tigre et les cris de la victime. Construit par des ingénieurs français pour la cour de Tipu, il est exposé au Victoria and Albert Museum de Londres depuis 1808 — l'un des objets les plus remarquables ayant survécu de la collaboration culturelle franco-indienne à l'époque coloniale. La [rue Tip Sahib](/fr/discover/white-town/tip-sahib-street), dans la Ville Blanche, porte aujourd'hui son nom.`,
...

  {
    ...
    name: "Eyre Coote",
    dates: "1726–1783",
    role: "Commandant britannique ; conquérant de Pondichéry",
    metaTitle: "Eyre Coote, le vainqueur de Wandiwash et de Pondichéry",
    metaDescription: "Coote détruisit la puissance militaire française à Wandiwash, captura Bussy, et mena le siège qui fit tomber Pondichéry.",
    teaser: "Le soldat né en Irlande qui mit fin à la puissance militaire française en Inde en une seule après-midi à Wandiwash, capturant Bussy, brisant l'armée de Lally, avant de mener le siège de cinq mois qui fit tomber Pondichéry.",
    body: `**LE SIÈGE**
...
L'ordre qui suivit de démolir la ville relevait d'une politique délibérée du commandement britannique : les fortifications de Pondichéry furent systématiquement démantelées afin qu'un éventuel comptoir français restauré ne puisse plus jamais fonctionner comme base militaire. La démolition dura des semaines. [Guillaume Le Gentil](/fr/history/lives-and-legacies/le-gentil), arrivant à Pondichéry sept ans plus tard pour observer le passage de Vénus, trouva une ville encore en reconstruction après ce que le siège et les démolitions qui suivirent lui avaient infligé.
...
Il arrive à Pondichéry comme les navires français y arrivaient depuis deux siècles : par la rade, la côte de Coromandel s'élevant lentement hors de la mer, les tours de [Notre-Dame des Anges](/fr/discover/landmarks/notre-dame) visibles au-dessus de la ligne d'eau avant même que la ville n'apparaisse. C'était une approche délibérée, celle d'un homme qui comprenait que la bonne manière d'entrer dans un lieu est celle par laquelle il fut conçu pour recevoir ses visiteurs. Il assiste à la messe à Notre-Dame des Anges, arpente la [rue Dumas](/fr/discover/white-town/rue-dumas) et la [rue de la Marine](/fr/discover/white-town/rue-de-la-marine), et circule entre la Ville Blanche et les rues tamoules de la Ville Noire avec l'attention d'un homme formé à l'observation minutieuse des environnements étrangers.
...
François Pierre Eustache Gaudart naît à Karikal en 1844, dans une famille dont le lien avec la France remontait à l'époque de la Compagnie des Indes. Son grand-père avait servi la Compagnie des Indes orientales au XVIIIe siècle ; François naît dans la troisième génération d'une famille qui s'était pleinement intégrée à la classe professionnelle catholique de l'Inde française, sans jamais tout à fait perdre ses origines parisiennes. Il se forme au droit, est admis au barreau de Karikal en 1864, à vingt ans, et plaide devant les tribunaux de Karikal et de Pondichéry pendant plus de quarante ans.

Sa carrière politique fut le fruit de l'extension par la Troisième République des institutions municipales françaises aux territoires d'outre-mer. Quand la loi municipale de 1880 créa les premières municipalités élues de l'Inde française, Gaudart fut élu premier maire de Karikal le 30 mai 1880, une fonction d'une réelle portée démocratique dans un territoire où la participation civique formelle avait jusque-là été restreinte. Il siégea ensuite comme conseiller général de l'Inde française de 1879 à 1890, puis comme adjoint au maire de Pondichéry et conseiller privé du gouvernement de l'Inde française. Il reçut la Légion d'honneur le 4 août 1914.

Ses ambitions industrielles furent d'une ampleur remarquable. En 1902, en partenariat avec ses fils ingénieurs, il fonda l'usine métallurgique Gaudart-Sainte-Élisabeth à Pondichéry, qui employa à son apogée entre deux et quatre mille ouvriers indiens, supervisés par douze contremaîtres belges. La vente de l'usine en 1919, pour environ 75 millions de francs, fut l'une des plus importantes transactions industrielles de l'histoire de l'Inde française.

Peu avant sa mort, il fit don à [Notre-Dame des Anges](/fr/discover/landmarks/notre-dame) de la statue en marbre de Carrare de Jeanne d'Arc, installée l'année de sa canonisation, qui se dresse encore aujourd'hui dans l'église, ainsi que le jardin public attenant. Il meurt à Cannes en juin 1923, quelques mois après l'installation d'un don qui demeure l'un des objets les plus visités de la Ville Blanche de Pondichéry.`,
  },
...
L'[avenue Goubert](/fr/discover/white-town/avenue-goubert), la promenade en bord de mer de Pondichéry, porte son nom, rappel que l'homme le plus responsable de la prolongation de la domination française fut aussi celui dont le revirement y mit fin.`,
  },
...
Charles François Baron naît à Paris en 1900, passe le début de sa vingtaine en marge du mouvement surréaliste naissant, présent aux réunions où Louis Aragon, Man Ray et André Breton définissaient ce qui allait devenir le surréalisme, puis part pour l'Afrique de l'Ouest en 1927 après avoir achevé des études de droit et d'administration coloniale. Il fait un premier séjour à Pondichéry vers 1935, en simple voyageur de passage, croise des disciples de [Sri Aurobindo](/fr/history/lives-and-legacies/sri-aurobindo) dans les rues au coucher du soleil, et engage ces conversations sur la philosophie hindoue qui plantèrent une curiosité spirituelle qu'il allait cultiver toute sa vie.
...
Nommé gouverneur de l'Inde française en 1945, il sert pendant toute la période du transfert, jusqu'en 1954. Parmi ceux qu'il fait venir à Pondichéry cette année-là se trouve un jeune vétéran français nommé Bernard Enginger, plus tard connu sous le nom de Satprem, qui pesait environ 35 kilogrammes après les épreuves de la guerre et, selon ses propres mots, envisageait le suicide. Baron l'installe comme son secrétaire personnel. La rencontre d'Enginger avec Sri Aurobindo et la Mère à [l'Ashram](/fr/discover/landmarks/ashram) le transforme en l'une des figures les plus marquantes de la tradition aurobindienne : auteur d'œuvres auxquelles on attribue d'avoir attiré des centaines de milliers de chercheurs spirituels à Pondichéry.
...
En septembre 1947, pour la première fois depuis 1928, il reçoit des visiteurs extérieurs : Maurice Schumann, voix de la France libre pendant la guerre, et le gouverneur Baron. Après l'entrevue, la Mère défie Schumann à une partie de ping-pong et la remporte largement, puis passe le reste de la soirée à l'interroger sur la France d'après-guerre. Sri Aurobindo meurt le 5 décembre 1950. L'Ashram demeure la plus grande institution de la Ville Blanche. [Auroville](/discover/auroville/what-is-auroville), la cité internationale inspirée par sa vision de l'unité humaine, est inaugurée en 1968 sur le plateau de latérite rouge au nord de la ville. Son anniversaire, le 15 août, est marqué chaque année à l'Ashram comme l'un de ses [quatre jours de Darshan annuels](/fr/festivals/sri-aurobindo-birthday).`,
  },
...
Il retourne en Inde britannique en 1919, est brièvement arrêté, et meurt à Madras en septembre 1921, à trente-huit ans. La cause de sa mort fut les blessures infligées par un éléphant de temple qu'il s'était pris d'amitié et nourrissait régulièrement, au temple de Parthasarathy à Triplicane ; il ne s'en remit jamais. Le gouvernement indien acquiert les droits sur son œuvre en 1949, la plaçant dans le domaine public ; son anniversaire, le 11 décembre, est célébré dans tout le Tamil Nadu comme la *Journée du poète tamoul*. Le [Bharathi Park](/fr/discover/landmarks/bharathi-park), le grand jardin central de la Ville Blanche, ancien *Jardin de la Compagnie* de l'époque coloniale française, porte son nom. Sa maison, rue Eswaran Koil, est entretenue comme site patrimonial par le département du Tourisme de Pondichéry.`,
  },

  {
    ...
    name: "V. Subbiah",
    dates: "1911–1993",
    role: "Dirigeant syndical ; militant pro-fusion",
    metaTitle: "V. Subbiah, dirigeant communiste de la fusion de Pondichéry",
    metaDescription: "Le dirigeant syndical bâtit le mouvement de masse qui fit de la fusion de Pondichéry avec l'Inde une cause populaire plutôt qu'élitiste.",
    teaser: "Le dirigeant syndical communiste qui bâtit la base populaire ayant fait du mouvement pro-fusion à Pondichéry un phénomène de masse plutôt qu'une affaire de notables.",
    body: `**LA VOIX DES TRAVAILLEURS**
...
Samogneux fut prise. Il est cité à l'ordre du 55e régiment le 4 avril 1918 : *« Jeune chef de section plein d'allant, d'un calme et d'un sang-froid remarquables. Mortellement blessé le 21 août 1917 en entraînant ses hommes à travers un réseau de fil de fer ennemi. »* Il reçoit à titre posthume la Croix de guerre et la Médaille militaire en 1920. La ville de Verdun l'inscrit dans son livre d'or : *« le seul enfant de l'Inde à partager avec des soldats de tout rang l'honneur d'avoir contribué à la défense héroïque de la ville mémorable. »* Son nom figure sur le [Monument aux morts français](/fr/discover/landmarks/war-memorial), sur l'avenue Goubert. Le seul enfant de l'Inde mort à Verdun.
...
Il devient ensuite shérif de Bombay en 1942, rejoint le service diplomatique indien, et en 1947 est affecté à Pondichéry comme premier consul général de l'Inde auprès des établissements français et portugais en Inde, premier représentant diplomatique de l'Inde indépendante auprès de l'Inde française. Son bureau se trouvait au 7, rue des Capucins, la rue aujourd'hui appelée [rue Romain Rolland](/fr/history/lives-and-legacies/romain-rolland). Il arrive au moment précis où la relation de l'Inde avec les comptoirs français devenait une question politique brûlante : l'indépendance avait transformé les enclaves d'avant-postes coloniaux entourés par l'Inde britannique en quelque chose de plus précaire, désormais entourées par un État souverain ayant un intérêt manifeste à leur incorporation.
...
La défaite de Napoléon à Waterloo en juin 1815 et le règlement du congrès de Vienne qui suivit menèrent, après négociation, à la restitution de l'Inde française le 4 décembre 1816, la cinquième et dernière restitution de ce type après une guerre européenne, suivant le même schéma établi à Ryswick en 1697, à Aix-la-Chapelle en 1748, à Paris en 1763 et à Versailles en 1783. Aucun territoire français en Inde ne fut plus jamais saisi par la force. Même son héritage administratif survécut à sa politique : le Code napoléonien et le système judiciaire et civil centralisé qu'il bâtit en métropole furent transposés en Inde française et façonnèrent la manière dont Pondichéry fut gouvernée au XIXe siècle, longtemps après le départ de l'empereur qui n'y était jamais venu.`,
...

  {
    ...
    dates: "1890–1970",
    role: "Président de la République française ; ratifia le transfert de l'Inde française à l'Inde en 1962",
    metaTitle: "Charles de Gaulle et la fin de l'Inde française",
    metaDescription: "De Gaulle ne bâtit pas l'Inde française. Son gouvernement signa la loi qui y mit légalement fin, six ans après que la ville eut déjà changé de mains.",
...
L'héritage le plus durable de son gouvernement pour Pondichéry fut culturel plutôt que juridique. Son ministre de la Culture, André Malraux, rencontre Jawaharlal Nehru en novembre 1958, et leur conversation sur la place de la culture française dans l'Inde indépendante façonna le cadre qui permit à des institutions comme l'Institut français de Pondichéry et le lycée français de la ville de continuer à fonctionner après 1962, préservant le statut de Pondichéry comme, selon les mots mêmes de Nehru, une fenêtre sur la culture française. De Gaulle ne fit pas l'Inde française. Il signa les papiers qui refermaient le dossier d'une histoire dont les scènes décisives avaient déjà été jouées, sous Louis XV et Dupleix deux siècles plus tôt, et sous Nehru et [Édouard Goubert](/fr/history/lives-and-legacies/edouard-goubert) quelques années à peine avant que sa propre signature n'en fasse une affaire définitive.`,
  },

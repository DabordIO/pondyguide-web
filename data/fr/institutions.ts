export interface InstitutionArticleFr {
  id: string;
  title: string;
  subtitle: string;
  teaser: string;
...
export const institutionArticlesFr: InstitutionArticleFr[] = [
  {
    ...
    subtitle: "Fondé en 1826 sous le nom de Collège royal de Pondichéry. Bicentenaire : 2026.",
    metaTitle: "Lycée français international, fondé en 1826 à Pondichéry",
    metaDescription: "Fondé en 1826, le Lycée français international célèbre son bicentenaire en 2026, l'une des plus anciennes écoles françaises hors de France.",
    teaser: "À l'automne 1826, le même gouverneur qui ouvrit le Pensionnat de jeunes filles fonda aussi un collège pour garçons. Près de deux siècles plus tard, les deux institutions sont toujours ouvertes. Le Lycée est le plus ancien des deux de quelques semaines.",
    body: `Le 26 octobre 1826, le gouverneur Eugène Desbassayns de Richemont signa le décret fondateur d'un collège pour garçons à Pondichéry. Il l'appela le Collège royal de Pondichéry. Il est encore ouvert aujourd'hui, près de deux siècles plus tard, sous le nom de Lycée français international de Pondichéry. Son bicentenaire tombe en 2026, ce qui en fait l'une des plus anciennes écoles françaises d'outre-mer en activité continue au monde.

Le même jour, le même gouverneur signait le décret fondateur du [Pensionnat de jeunes filles](/fr/history/institutions/pensionnat). Deux institutions, une année, un même administrateur. Ensemble, elles définirent la structure de l'enseignement colonial français en Inde pour le siècle qui suivit.
...
Cette continuité à travers trois régimes, à travers le colonial et le postcolonial, à travers la souveraineté française et indienne, est en elle-même l'argument de ce qu'est cette école et de ce qu'elle représente à Pondichéry.`,
...

  {
    ...
    subtitle: "Le fil diplomatique qui ne fut jamais rompu",
    metaTitle: "Consulat général de France, les citoyens français à Pondichéry",
    metaDescription: "La France maintient un consulat général à Pondichéry car des milliers de résidents ont choisi la citoyenneté française après le transfert de 1962.",
    teaser: "La France est l'un des rares pays à maintenir un consulat général dans une ville de la taille de Pondichéry. La raison est précise : après 1962, des milliers de Pondichériens choisirent la citoyenneté française et eurent besoin d'un État vers lequel se tourner.",
    body: `Le Consulat général de France à Pondichéry n'est pas une simple mission diplomatique parmi d'autres. C'est le successeur institutionnel direct de près de trois siècles d'administration française en Inde : l'une des très rares représentations diplomatiques au monde à avoir évolué d'un ancien gouvernement colonial vers un bureau consulaire moderne sans jamais fermer, sans jamais déménager, et sans jamais rompre le fil de continuité institutionnelle qui la relie au premier comptoir de [François Martin](/fr/history/lives-and-legacies/francois-martin) en 1674.
...
Aujourd'hui, il sert aussi de centre de coordination pour la présence institutionnelle française dans tout le sud de l'Inde : l'[Alliance française de Pondichéry](/fr/history/institutions/alliance-francaise), le [Lycée français international](/fr/history/institutions/lycee-francais), l'[EFEO](/fr/history/institutions/efeo), et le réseau plus large d'activité culturelle et de recherche françaises dans la région. Sa juridiction s'étend au-delà de Pondichéry pour couvrir le Tamil Nadu par son bureau de Chennai.
...
L'EFEO maintient des établissements à travers l'Asie. Le centre de Pondichéry en est sans doute le plus important : le lieu où l'étude de la civilisation indienne, dans toute sa profondeur historique, textuelle, spatiale et matérielle, a été poursuivie avec le plus grand sérieux soutenu, et où deux manières complémentaires de lire l'Inde, par ses textes et par ses paysages, ont été développées côte à côte pendant soixante-dix ans.`,
...

  {
    ...
    subtitle: "Fondé en 1792, l'une des plus anciennes écoles d'Inde en activité continue",
    metaTitle: "Petit Séminaire, deux siècles d'enseignement à Pondichéry",
    metaDescription: "Fondé à la fin du XVIIIe siècle pour former le clergé, le Petit Séminaire a continué d'éduquer des garçons à travers chaque transition politique.",
    teaser: "Créé pour former le clergé dans la dernière décennie du XVIIIe siècle, il enseigne aux garçons sans interruption depuis. Chaque transition politique que la ville a connue, il y a survécu.",
    body: `Il existe une école au cœur de Pondichéry qui enseigne aux garçons depuis 1792. Elle a changé de nom, changé de langue, changé de système d'examen, et changé sa relation à l'Église comme à l'État. Elle n'a jamais fermé. Ce que l'on voit en se tenant devant elle aujourd'hui est l'expression physique de chaque transition politique et religieuse que cette ville a traversée, accumulée dans la pierre sur deux siècles et demi.
...
Parmi ses anciens élèves figurent Prapanchan, l'écrivain tamoul S. Vaidyalingam, lauréat du prix Sahitya Akademi, ainsi que des générations de clergé, d'universitaires, de fonctionnaires et de professionnels qui portent une trace de son héritage particulier. Une institution catholique française devenue, sans jamais tout à fait l'avoir voulu, une institution pleinement indienne.`,
...

  {
    ...
    subtitle: "Langue et culture françaises, avec une résonance locale particulière",
    metaTitle: "Alliance française de Pondichéry, centre de langue française",
    metaDescription: "L'Alliance française de Pondichéry opère dans une ville où le français fut, de mémoire vivante, une langue officielle de l'administration.",
...
L'Alliance française de Pondichéry attire un public d'élèves qui serait inhabituel dans toute autre ville indienne. Certains viennent parce qu'ils descendent de familles francophones deux générations plus tôt et souhaitent renouer avec quelque chose. Certains viennent parce que le français est une qualification professionnelle dans l'hôtellerie, la diplomatie ou les affaires européennes. Certains viennent simplement parce qu'ils habitent une rue au nom français et veulent comprendre ce qu'il signifie. Trois raisons différentes, la même salle de classe. Ce mélange particulier est l'une des choses qui distinguent cette institution de toute autre Alliance française en Inde.`,
...

  {
    ...
    subtitle: "Fondé en 1826, sécularisé par la France en 1903, puis absorbé par l'Inde",
    metaTitle: "Pensionnat de jeunes filles, l'éducation des filles depuis 1826",
    metaDescription: "Première institution structurée d'éducation des filles en Inde française, ouverte en 1826 et toujours en activité sous administration indienne.",
    teaser: "La première institution structurée d'éducation des filles en Inde française. Fondée par des missionnaires, reprise par l'État colonial en 1903, et transférée à l'administration indienne en 1954. Elle est encore ouverte aujourd'hui.",
    body: `En 1826, l'administration coloniale française de Pondichéry prit une décision délibérée : ouvrir une école formelle pour filles. Avant cela, l'éducation féminine structurée en Inde française était extrêmement limitée. Le gouverneur Eugène Desbassayns de Richemont signa le décret fondateur et confia l'institution aux [Sœurs de Saint-Joseph de Cluny](/fr/history/institutions/cluny-schools), arrivées à Pondichéry l'année précédente. L'école qu'elles ouvrirent fut le Pensionnat de jeunes filles : la première institution structurée d'éducation des filles en Inde française.
...
Elle fonctionne aujourd'hui comme une école publique, enseignant toujours dans la même ville, sur la lignée historique remontant à 1826. Un pensionnat colonial pour les filles d'administrateurs français, sécularisé par la République en 1903 et nationalisé par l'Inde en 1954, est encore ouvert. Cette survie à travers trois formes d'autorité est ce qui la rend singulière.`,
  ...
  {
    id: "cluny-schools",
    title: "Les écoles Cluny",
    subtitle: "Sœurs de Saint-Joseph de Cluny, à Pondichéry depuis 1827",
    metaTitle: "Les écoles Cluny, des sœurs françaises à Pondichéry depuis 1827",
    metaDescription: "Les Sœurs de Saint-Joseph de Cluny arrivèrent à Pondichéry en 1827 et éduquent des générations de filles depuis.",
    teaser: "Anne-Marie Javouhey fonda sa congrégation en 1807 pour éduquer des filles que personne d'autre n'éduquait. Ses sœurs arrivèrent à Pondichéry vingt ans plus tard et y sont restées depuis.",
    body: `Quand Anne-Marie Javouhey fonda les Sœurs de Saint-Joseph de Cluny à Chalon-sur-Saône en 1807, elle allait à contre-courant de son époque sur presque tous les points qui comptaient. L'éducation des filles n'était pas considérée comme essentielle. Le travail missionnaire dans les colonies était considéré comme un domaine masculin. La dignité des personnes réduites en esclavage et colonisées n'était pas un sujet sur lequel les institutions catholiques françaises prenaient habituellement position publiquement. Javouhey en prit une sur les trois. Elle fut béatifiée par l'Église catholique en 1950.
...
Javouhey ne visita jamais Pondichéry. Son image apparaît néanmoins dans les écoles qu'elle fonda, rappel que le projet éducatif que ses sœurs mènent depuis deux siècles a une origine précise et un ensemble précis d'engagements. Les écoles qu'elle mit en mouvement enseignent encore à des filles dans une ville qu'elle ne vit jamais, suivant une vision qu'elle forma en Bourgogne au tout début du XIXe siècle. Cette continuité, à travers l'empire et l'indépendance, à travers le français et l'anglais, à travers le colonial et le national, est ce que représentent les écoles Cluny à Pondichéry.`,
...

  {
    id: "calve-college",
    title: "Collège Calvé",
    subtitle: "Fondé en 1875 par un philanthrope tamoul, aujourd'hui école patrimoniale en restauration",
    metaTitle: "Collège Calvé, collège patrimonial de 1875 à Pondichéry",
    metaDescription: "Fondé en 1875 par Calvé Soupraya Chettiar pour les enfants hindous et musulmans, le collège devint plus tard un foyer de politique nationaliste.",
    teaser: "Calvé Soupraya Chettiar utilisa son propre argent en 1875 pour ouvrir une école destinée aux enfants hindous et musulmans qui n'avaient nulle part ailleurs où aller. Le collège qui porte son nom devint plus tard une pépinière de politique nationaliste, et est aujourd'hui un bâtiment patrimonial recensé, en cours de restauration.",
    body: `En 1875, un marchand tamoul nommé Calvé Soupraya Chettiar, également connu sous le nom de Kalavai Subburaya Chettiar, utilisa son propre argent pour ouvrir une école à Pondichéry. Son raisonnement était direct : les enfants des familles hindoues et musulmanes de la ville indienne avaient peu d'options éducatives qui ne fussent pas contrôlées par des missionnaires chrétiens. Il voulut en créer une.
...
Les archives patrimoniales le situent dans ce qu'elles décrivent comme le « triangle des écoles patrimoniales » de Pondichéry : le Collège Calvé, l'école V.O.C., et le Pensionnat de jeunes filles. Trois institutions qui, ensemble, documentent tout l'éventail de l'éducation à l'époque coloniale dans la ville : philanthropique indien, colonial français, et missionnaire catholique. Chacune raconte une histoire différente sur qui était éduqué, par qui, et dans quel but. Ensemble, elles rendent visible la stratification éducative d'une ville qui, pendant trois siècles, essaya d'être française et indienne à la fois.`,
...

  {
    ...
    subtitle: "L'après-vie sociale de l'armée impériale française à Pondichéry",
    metaTitle: "Foyer du soldat, foyer des vétérans indo-français",
    metaDescription: "Créé pour les vétérans tamouls revenant du service dans l'armée française, le Foyer du soldat préservait une mémoire militaire en voie de disparition à Pondichéry.",
    teaser: "Des milliers d'hommes tamouls de Pondichéry servirent dans l'armée française à travers quatre guerres et trois continents. À leur retour, ils avaient besoin d'un endroit où se poser. Le Foyer du soldat fut ce lieu : à la fois abri, club, et gardien d'une mémoire aujourd'hui presque entièrement disparue.",
    body: `Le Foyer du soldat à Pondichéry était une institution sociale et d'entraide liée au système militaire français : un espace de détente, un lieu de rencontre pour anciens combattants, et un centre de soutien pour les soldats des Indes françaises, ces hommes qui avaient combattu pour la France à travers le monde et étaient rentrés dans une ville qui changeait plus vite qu'aucun d'entre eux ne l'avait anticipé.
...
export function getInstitutionArticleFr(id: string): InstitutionArticleFr | undefined {
  return institutionArticlesFr.find((a) => a.id === id);
}

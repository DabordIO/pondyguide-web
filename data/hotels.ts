...
export const hotels: Hotel[] = [
...

  {
    ...
    exploreNearby:
      "You're only a short drive from White Town, making it easy to spend your mornings exploring museums, churches and seaside cafés before returning for an afternoon swim. If shopping is on your itinerary, the city's independent boutiques, artisan stores and local handicraft shops offer an excellent introduction to Puducherry's creative spirit.\n\nThe [Basilica of the Sacred Heart of Jesus](/discover/landmarks/sacred-heart), completed in 1908, is one of India's finest examples of Neo-Gothic church architecture. Its stained-glass windows, designed and manufactured in France, depict scenes from the life of Christ with extraordinary richness of colour. On a bright morning, sunlight pours through the glass and transforms the interior into one of Puducherry's most memorable spaces. Even visitors with little interest in church architecture often find themselves lingering longer than expected.\n\nA short distance away, the [Puducherry Museum](/discover/landmarks/museum) offers one of the best introductions to the city's layered past. Roman amphora fragments, beads and ceramics excavated at nearby Arikamedu reveal that international trade flourished here nearly two thousand years before the French arrived. Upstairs, colonial furniture, maps and everyday objects from the French administration help bring the city's more recent history vividly to life. It is compact enough for families yet rewarding for anyone curious about how Puducherry became unlike anywhere else in India.\n\nBegin one morning on [Goubert Avenue](/discover/white-town/avenue-goubert) before the city fully wakes. The Promenade remains blissfully quiet, fishermen return with the night's catch and walkers claim the broad seafront before the tropical heat gathers. Stroll from the [Gandhi Statue](/discover/landmarks/gandhi-statue) towards the [old Lighthouse](/discover/landmarks/old-lighthouse), pausing at the [French War Memorial](/discover/landmarks/war-memorial) along the way. It is one of those walks that explains Puducherry better than any guidebook can.",
    bestFor: [
      "Families",
...

  {
    ...
    exploreNearby:
      "Within minutes you can reach the Promenade, the [Sri Aurobindo Ashram](/discover/landmarks/ashram), museums, cafés and Pondicherry's lively shopping streets. If you're travelling with children, the city's famous ice cream parlours make an excellent reward after a morning spent exploring churches, temples and heritage buildings.\n\nPondicherry takes ice cream more seriously than most visitors expect. Several cafés stock the excellent Auroville-made ice cream, produced from milk supplied by Auroville's own dairy. The vanilla is exceptionally good, while seasonal flavours such as mango, sitaphal and tender coconut appear throughout the year depending on the harvest. Sampling different cafés quickly becomes a small mission in itself, particularly for younger travellers.\n\nThe [Manakula Vinayagar Temple](/discover/landmarks/manakula-vinayagar), one of the oldest temples in Pondicherry, lies just beyond White Town and offers one of the city's most engaging cultural experiences. Dedicated to Lord Ganesha, it predates the arrival of the French and has remained at the heart of local religious life ever since. Its colourful gopuram, lively courtyards and constant stream of devotees make it an unforgettable introduction to South Indian temple culture.\n\nIf you have older children or teenagers, set aside half a day for the [Auroville Visitor Centre](/discover/auroville/how-to-visit). Few places in India tell a more unusual story. Founded in 1968 as an international township dedicated to human unity, [Auroville](/discover/auroville/what-is-auroville) today brings together residents from dozens of countries living among forests that they themselves planted on once-barren laterite land. The Visitor Centre explains the vision clearly, while the shaded walk to the [Matrimandir](/discover/auroville/the-matrimandir) viewing point offers an excellent introduction before deciding whether to book a visit inside on a future trip.",
    bestFor: [
      "Families",
      "First-time visitors",
      "Domestic tourists",

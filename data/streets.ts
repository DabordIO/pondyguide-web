...
export const streets: Street[] = [
  ...
  },
  {
    ...
    lng: 79.8335,
    summary:
      "Welcome to Rue Victor Simonel, one of the busiest streets in the White Town. It runs north to south from Ananda Ranga Pillai Street to Rue Bussy, and along the way you pass the General Hospital, the Maternity Hospital, the Legislative Assembly, St. John's Church, and the Lycée Français. The European Cemetery is here too. Victor Simonel was a soldier from Pondicherry killed at Verdun in 1916. His street did not stay quiet.",
    history:
  ...
  },
  {
    ...
    notable: [
      ...
      "The Grand Bazaar was the commercial heart of Pondicherry. Ananda Ranga Pillai's house faced it. His diary records the prices, gossip, and anxieties of a market that connected the White Town to the Tamil quarter.",
  ...
  },
  {
    ...
    history:
      "The Missions Étrangères de Paris established the Catholic mission in Pondicherry from the early years of the French settlement, arriving in 1674 alongside the first French traders. For three centuries the MEP maintained the Church's presence in French India: building churches, running schools, burying the dead in the cathedral cemetery on Rue Dumas, and in time establishing the episcopal hierarchy that this street commemorates.\n\nIn 1776 the MEP took over the Carnatic mission from the departing Jesuits, its superior based here in Pondicherry, though still decades from having a bishop of its own. Pondicherry was not raised to an Apostolic Vicariate until 1836, with Mgr. Bonnand as its first vicar apostolic, and the vicariate was elevated to a full archdiocese in 1886. The évêché, the bishop's palace and administrative seat, gave its name to this lane, which sits between the canal and Rue Victor Simonel in the quieter western edge of the White Town grid.\n\nOne villa on the street still carries that history forward. Dating to the 1790s, it later passed to the Goubert family, whose name lives on in Pondicherry's Goubert Market, and today operates as a heritage hotel, Résidence de l'Évêché, on the very lane the bishopric named.\n\nIt is a small street. Not every street in a colonial city is named after a battle or a governor. Some are named for the institutions that held the fabric of daily life together: the company, the church, the bishop's house at the end of a quiet lane.",
    notable: [
      ...
      "The MEP took over the mission from the Jesuits in 1776, but Pondicherry only became an Apostolic Vicariate in 1836. The vicariate was elevated to an archdiocese in 1886.",
      "A 1790s villa on the street later belonged to the Goubert family, namesake of Pondicherry's Goubert Market. It's now a heritage hotel, Résidence de l'Évêché.",
  ...
  },
  {
    ...
    metaTitle: "Ananda Ranga Pillai Street, Dubash of French India",
    ...
    name: "Ananda Ranga Pillai Street",
    axis: "E-W",
    ...
    lng: 79.8325,
    summary:
      "Welcome to Ananda Ranga Pillai Street, named after the man who ran French India from the inside. He was not French. He was the dubash, the chief broker and interpreter of the Compagnie des Indes, the Indian without whom the French colonial machine would not have turned. He also kept a diary. Twelve volumes, in Tamil. His house, built in 1735, is still on this street.",
    history:
  ...
  },
  {
    ...
    notable: [
      ...
      "French War Memorial, maintained by the French Consulate. An Armistice Day ceremony is held here every 11 November. The names of Pondicherrian soldiers killed in both World Wars are carved on it.",
      "Three statues along the promenade, though not clustered together: Gandhi and Nehru stand near the northern end, close to Raj Nivas. Dupleix stands alone, well to the south, near where the avenue curves into South Boulevard. The man who tried to make France the dominant power in India, and the men who removed the British: same boulevard, opposite ends of it.",
      "Raj Nivas, at the northern end near Bharathi Park, was built in 1738 by Governor Dumas as the French Governor's residence. It is now the home of the Lieutenant Governor of the Union Territory.",
  ...
  {
    id: "tip-sahib-street",
    metaTitle: "Tipu Sahib Street, Tipu Sultan Street in White Town",

...
export const figures: Figure[] = [
  {
    ...
    photo: "dupleix.jpg",
    teaser: "The man who dreamed of a French empire in India, built it piece by piece through alliances and sepoys, and lost it not to British arms but to a recall order from Paris.",
    body: `**THE ARCHITECT OF FRENCH INDIA**
...
His method was audacious and, for a time, stunningly effective. When the Nizam of Hyderabad died in 1748 and succession crises opened simultaneously in Hyderabad and the Carnatic, he moved fast. He backed [Chanda Sahib](/history/lives-and-legacies/chanda-sahib) for the Nawabship of the Carnatic, placed a friendly Nizam at Hyderabad through his brilliant field commander [Bussy](/history/lives-and-legacies/charles-de-bussy), and at his peak claimed an indirect sovereignty over a territory larger than France itself. The mechanism was not European-style conquest but strategic patronage: French-trained sepoys at key courts as the silent collateral behind Indian thrones.
...
His statue stands on [Goubert Avenue](/discover/white-town/avenue-goubert), arm raised toward the sea. [Rue Dupleix](/discover/white-town/rue-dupleix) runs through the heart of the White Town. The city he governed still carries his name on its oldest street, and the logic of his experiment, using local politics rather than direct conquest, would be reinvented, in very different form, by the British in the century that followed.`,
  },
...
What followed was a catastrophe of a different order. La Bourdonnais had promised the British garrison lenient terms, a cash ransom, civilian parole, and a French departure before the northeast monsoon closed the anchorage. [Dupleix](/history/lives-and-legacies/dupleix) wanted to retain Madras as a permanent French possession. The quarrel between them was bitter, public, and consequential: La Bourdonnais departed with his squadron, leaving a garrison without naval support; the position eventually proved untenable.

He returned to France expecting recognition. Instead, his enemies were waiting. Imprisoned in the Bastille in late 1746 on charges connected to the Madras dispute, he spent nearly two years there before acquittal in 1748, but the imprisonment destroyed his health. He spent his remaining years writing his memoirs, a vigorous defence of his conduct, and died in Paris in November 1753, aged fifty-four, still unrecognised, while Dupleix was still governing in Pondicherry and the wars he had begun were still being fought. Two streets in the White Town, [Rue Mahé de La Bourdonnais](/discover/white-town/rue-mahe-de-la-bourdonnais) and [Labourdonnais Street](/discover/white-town/labourdonnais-street), still carry his name.`,
  },
...
At the Battle of Ambur on 3 August 1749, a combined French-Mysorean force defeated and killed Anwaruddin Khan, the incumbent Nawab. Chanda Sahib was proclaimed Nawab of the Carnatic. He rewarded the French generously: he appointed [Dupleix](/history/lives-and-legacies/dupleix) commander of his armies, granted France the village of [Villianur](/festivals/villianur-car-festival), and confirmed French possession of Karikal. The British-backed rival Muhammad Ali retreated to the rock fortress of Trichinopoly, which became the nucleus of resistance.

The British response was Robert Clive's seizure of Arcot in 1751, which diverted Chanda Sahib's forces from the critical siege. The campaigns of 1751 and 1752 went steadily against the French alliance. On 12 June 1752, on the same afternoon that the French force under [Law de Lauriston](/history/lives-and-legacies/law-de-lauriston) surrendered at Srirangam, Chanda Sahib was captured by soldiers of the Tanjore army and beheaded. His death ended Dupleix's most ambitious political construction in a single catastrophic afternoon.`,
  },
...
He coordinated directly with [Hyder Ali](/history/lives-and-legacies/hyder-ali), and then, after Hyder Ali's death in December 1782, with [Tipu Sultan](/history/lives-and-legacies/tipu-sultan), who was fighting Britain from the land side in the Second Anglo-Mysore War. Their cooperation was the most credible Franco-Indian military combination since the Dupleix era: a French admiral controlling the sea while Mysore threatened British positions from the interior.

The peace of 1783 ended his campaign before a decision could be reached. He returned to France celebrated as a hero, was promoted Vice-Admiral, and died in Paris in December 1788, possibly in a duel arising from one of his many personal quarrels. His campaign represents the last moment at which France might realistically have recovered its naval position in the Indian Ocean. A [street in the White Town](/discover/white-town/rue-suffren) bears his name.`,
  },
...
His seizure of Arcot in September 1751, with two hundred men, was the strategic pivot of the Second Carnatic War. By taking Arcot, the traditional seat of the Nawabs of the Carnatic, Clive forced [Chanda Sahib](/history/lives-and-legacies/chanda-sahib) to divert forces from the critical siege of Trichinopoly, where the British-backed Muhammad Ali was holding out. He then held Arcot for fifty days against a besieging force many times his size, repulsing a major assault on the night of Muharram, 14 November 1751. The moral effect was lasting: it demonstrated that British-commanded Indian troops could hold fortified positions against much larger French-allied forces. At Srirangam in June 1752, he encircled the French force under [Law de Lauriston](/history/lives-and-legacies/law-de-lauriston) and compelled its capitulation on the same afternoon [Chanda Sahib](/history/lives-and-legacies/chanda-sahib) was beheaded. Dupleix's protectorate was over.
...
Jacques-François Law de Lauriston was born in 1719 into the Law family, connected by origin to the Scottish financier John Law whose famous "System," the Mississippi Bubble, which had briefly revolutionised French monetary policy before catastrophic collapse in 1720. The family association with spectacular ventures that ended badly was established before Jacques-François arrived in India. His career would confirm the pattern, through no particular fault of his own.
...
On 12 June 1752, on the island of Srirangam near Trichinopoly, he was encircled by [Clive](/history/lives-and-legacies/robert-clive)'s forces and compelled to surrender. The capitulation was complete. On the same day, at what may have been the same afternoon hour, Chanda Sahib, the French-backed Nawab of the Carnatic whose installation had been the centrepiece of Dupleix's strategy, was captured by soldiers of the Tanjore army and beheaded. The convergence of these two events in a single afternoon marked the definitive end of Dupleix's Carnatic protectorate: the French military force gone, the Indian client ruler dead, the British-backed candidate Muhammad Ali confirmed as Nawab.

Law de Lauriston was released after capitulation, continued in French service, and lived until 1797, outlasting French India's military ambitions by more than four decades. He died the year Bonaparte returned from Egypt, while [Napoleon](/history/lives-and-legacies/napoleon-bonaparte) was still dreaming of India. [Rue Law de Lauriston](/discover/white-town/rue-law-de-lauriston) in the White Town carries his name.`,
  },
...
He died on 7 December 1782 of a lumbar abscess, at the moment of maximum French strategic engagement with Mysore. One of his last French officers, a captain named Bouthenot, wrote: *"Ce grand homme avait de l'estime pour notre nation"*: this great man held our nation in esteem. His son [Tipu Sultan](/history/lives-and-legacies/tipu-sultan) inherited the throne, the army, and the French alliance. [Hyder Ali Street](/discover/white-town/hyder-ali-street) in the White Town carries his name today.`,
  },
...
He arrived at Pondicherry the way French ships had arrived for two centuries: approaching from the roadstead, the Coromandel Coast rising slowly from the sea, the towers of [Notre-Dame des Anges](/discover/landmarks/notre-dame) visible above the waterline before the city itself appeared. It was a deliberate approach, the approach of a man who understood that the right way to enter a place is from the direction it was designed to receive visitors. He attended Mass at Notre-Dame des Anges, walked [Rue Dumas](/discover/white-town/rue-dumas) and [Rue de la Marine](/discover/white-town/rue-de-la-marine), and moved between the White Town and the Tamil streets of the Black Town with the attentiveness of a man trained in close observation of foreign environments.
...
Shortly before his death he donated to [Notre-Dame des Anges](/discover/landmarks/notre-dame) the marble statue of Joan of Arc, carved in Carrara marble, installed in the year of her canonisation, that still stands in the church today, along with the adjacent public garden. He died in Cannes in June 1923, months after the installation of a gift that remains one of the most visited objects in Pondicherry's White Town.`,
  },
...
[Goubert Avenue](/discover/white-town/avenue-goubert), the seafront promenade of Pondicherry, carries his name, a reminder that the man most responsible for prolonging French rule was also the man whose change of position ended it.`,
  },
...
Appointed Governor of French India in 1945, he served through the entire transfer period until 1954. Among those he brought to Pondicherry that year was a young French veteran named Bernard Enginger, later known as Satprem, who weighed approximately 35 kilograms after wartime hardship and, by his own account, was contemplating suicide. Baron installed him as his personal secretary. Enginger's encounter with Sri Aurobindo and the Mother at [the Ashram](/discover/landmarks/ashram) transformed him into one of the most significant figures in the Aurobindo tradition: author of works credited with drawing hundreds of thousands of seekers to Pondicherry.
...
In September 1947, for the first time since 1928, he received outside visitors: Maurice Schumann, wartime voice of the Free French, and Governor Baron. After the meeting, the Mother challenged Schumann to a game of ping-pong and won decisively, then spent the rest of the evening asking him about post-war France. Sri Aurobindo died on 5 December 1950. The Ashram remains the largest institution in the White Town. [Auroville](/discover/auroville/what-is-auroville), the international township inspired by his vision of human unity, was inaugurated in 1968 on the red laterite plateau north of the city. His 15 August birthday is marked at the Ashram every year as [one of its four annual Darshan Days](/festivals/sri-aurobindo-birthday).`,
  },
...
The Congrès de Kijour on 18 October 1954, at which 170 representatives voted for merger against 8, was the political culmination of a decade of activism in which Subbiah played a leading role. [The de facto transfer](/history/the-handover-1954) followed on 1 November 1954. He continued as a legislator in Pondicherry after the transfer, representing the Communist Party of India and advocating for workers' rights in the new context of a Union Territory. He died in 1993, having witnessed both the end of French colonial rule and Pondicherry's consolidation within independent India.`,
  },
...
His method was patient and exact where [Dupleix](/history/lives-and-legacies/dupleix)'s would later be ambitious and political. But in September 1676, at the fortress of Valdaour, he took a step that the historian Froidevaux identified as making him Dupleix's direct forerunner: he led a French force in a night assault on behalf of his Indian protector Chirkhan Loudy, exacting written guarantees first, then seizing the fortress and securing French Pondicherry's position in the same stroke. Military support for an Indian ally in exchange for political protection and territorial acknowledgement: the logic Dupleix would deploy at continental scale seventy years later, practised here in miniature by a man with thirty-odd soldiers and no metropolitan backing.
...
She initiated [Auroville](/discover/auroville/what-is-auroville) in 1968: a township intended to embody the ideal of human unity, built on the red laterite plateau north of Pondicherry. At the inauguration ceremony, representatives from 124 nations and 23 Indian states brought soil from their homelands and mingled it at the central point. She was ninety and did not attend in person. She died in Pondicherry on 17 November 1973. Her tomb is beside Sri Aurobindo's in the Ashram courtyard, beneath a frangipani tree. Thousands come to it every day. Her 21 February birthday is still marked at the Ashram every year, with [her private room opened to visitors for the day](/festivals/mothers-birthday).`,
...

  {
    ...
    photo: "le-gentil.jpg",
    teaser: "The astronomer who travelled halfway around the world twice to observe the transit of Venus, missed it both times, once because of a war, once because of a cloud, and left instead the most vivid European portrait of Pondicherry in the 1760s.",
    body: `**THE UNLUCKIEST ASTRONOMER IN HISTORY**
...
He sailed for home on 1 March 1770. A hurricane off Réunion nearly sank his ship on the return. A British warship intercepted him; he escaped through the diplomatic gift of a large sack of potatoes. He crossed the Pyrenees on 8 October 1771, *"after eleven years, six months, and thirteen days of absence."* In Paris he found his wife had remarried, believing him dead, and his estate had been plundered. He recovered his position at the Académie, remarried, had a daughter, wrote his memoirs, and died around 1792. His transit observations contributed nothing to science. His account of Pondicherry in the 1760s, the dress, the funerals, the temples, the pilgrimage rest-houses beside the roads, is irreplaceable.`,
...

  {
    ...
    photo: "eyre-coote.jpg",
    teaser: "The Irish-born soldier who ended French military power in India in a single afternoon at Wandiwash, capturing Bussy, breaking Lally's army, and then conducting the five-month siege that brought Pondicherry down.",
    body: `**THE SIEGE**
...
The Battle of Wandiwash on 22 January 1760 was the decisive engagement of the Third Carnatic War. Coote commanded the British force; Lally led the French. Coote used his cavalry to contain the French flanks while his infantry delivered the central blow. [Charles de Bussy](/history/lives-and-legacies/charles-de-bussy), recalled from Hyderabad against his own judgment by [Lally](/history/lives-and-legacies/lally), commanded the French cavalry and was captured during the engagement. The battle lasted one afternoon. When it ended, French offensive capacity in India was gone. Lally had no remaining force that could resist a British advance; his only option was to fall back to Pondicherry and wait for the siege.
...
[The subsequent order to demolish the city](/history/the-fallen-city) was a British command policy: Pondicherry's fortifications were systematically dismantled so that any restored French settlement could not again function as a military base. The demolition took weeks. [Guillaume Le Gentil](/history/lives-and-legacies/le-gentil), arriving in Pondicherry seven years later to observe the transit of Venus, found a city still rebuilding from what the siege and the subsequent demolitions had done to it.
...
Coote returned to Britain, was knighted in 1771, and came back to India in his late fifties as Commander-in-Chief during the Second Anglo-Mysore War. In his sixties he won a series of battles against Hyder Ali's forces in the Carnatic, demonstrating that his military abilities had not diminished with age. He died at Madras in April 1783, still on campaign, aged fifty-seven. He had been present at the beginning and the middle of British India's rise: at Plassey, where Bengal's revenues changed hands; at Wandiwash, where French military power ended; and at the battles against Mysore, where the next phase of resistance was being fought. The *East Indian Chronologist* recorded the fall of Pondicherry simply as: "Pondicherry taken for the first time by Colonel Coote," the phrase "for the first time" acknowledging that subsequent British occupations would follow, but that Coote's was the one that mattered.`,
...

  {
    ...
    dates: "1717–1795",
    role: "Nawab of the Carnatic",
    photo: "muhammad-ali-khan.jpg",
    teaser: "The British-backed Nawab whose forty-six years of survival, first in the fortress of Trichinopoly and then in the labyrinth of Company debt, that defined what the British presence in South India would eventually become.",
    body: `**THE NAWAB IN THE FORTRESS**
...
He is buried in the national necropolis at Bras-sur-Meuse, near Samogneux, tomb 262. In 2003, earth and a stone from Pondicherry were mixed with the Lorraine soil at the foot of his cross. Shortly after the Armistice, the government of the French Settlements renamed the old rue de la Monnaie in his honour. The street runs to the European Cemetery, the city's oldest burial ground, where the French colonial establishment lies. His plaque is also in the church at Yanam, another of France's Indian settlements, where devotees still come to offer prayers.`,
...

  {
    ...
    photo: "mirza-rashid-ali-baig.jpg",
    teaser: "The Sandhurst-trained Muslim aristocrat who broke with Jinnah over Partition, chose India, and arrived in Pondicherry in 1947 as the first face of independent India in the French city, at the precise moment everything was about to change.",
    body: `**THE MAN WHO CHOSE INDIA**
...
He went on to become Sheriff of Bombay in 1942, joined the Indian Foreign Service, and in 1947 was posted to Pondicherry as the inaugural Consul-General of India in the French and Portuguese Establishments in India, the first diplomatic representative of independent India to French India. His office was at 7 rue des Capucins, the street now known as [rue Romain Rolland](/discover/white-town/rue-romain-rolland). He arrived at the precise moment when India's relationship with the French settlements became a live political question: independence had transformed the enclaves from colonial outposts surrounded by British India into something more precarious, surrounded now by a sovereign state with a clear interest in their incorporation.
...
What followed was unusual for any period of eighteenth-century colonial government: a governor's wife who was also a working political partner. [Ananda Ranga Pillai](/history/lives-and-legacies/ananda-ranga-pillai), Dupleix's own dubash, recorded her activities in his diary in extraordinary detail, and his account is the most complete portrait of any woman in the primary sources for French India. He documents her direct involvement in appointing the colony's chief interpreter, in commercial licensing, in receiving Indian princes and their delegations, and in negotiating the political relationships on which [her husband's entire protectorate strategy](/history/dupleix-gamble) depended. Where French officers needed interpreters and went through formal channels, she went directly to the wives and female relatives of Indian rulers, women who were themselves serious political actors, and built the kind of access her husband could never have obtained on his own.

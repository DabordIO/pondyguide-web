...
The grid he laid out, the canal that divided the Tamil quarter from the French quarter, the street names that survive to this day: all of this was imposed on a landscape already thick with history. The French came late to a very old party. What they chose to do with their invitation is the story that follows.`,
  },
  {
    ...
    photo: "the-europeans-arrive.webp",
    photoFolder: "history",
    body: `The Europeans who changed this coast did not arrive all at once. They came over two centuries, each wave building on the wreckage of the last.
...
It was the long competition between French Pondicherry and British Madras that would define the history of the Coromandel Coast for the next century. The Portuguese had tried and left their faith. The Danes had tried and left their printing press. The Dutch had tried and calculated that the profit was elsewhere. Two remained, facing each other down the same narrow strip of coast. The contest between them would be decided not by trade, but by the ambitions of a single extraordinary governor who arrived in Pondicherry in 1742 convinced he could change the rules of the game.`,
  },
  {
    ...
    gradient: "linear-gradient(135deg, #1c2340 0%, #2d3a6b 100%)",
    photo: "british-siege-of-Dupleix-pondicherry.jpg",
    photoFolder: "history",
    body: `On the morning of 15 January 1742, Joseph François Dupleix stepped ashore at Pondicherry to the thunder of twenty-one cannon salutes. He had already decided what kind of governor he intended to be. The Compagnie des Indes had sent him to run a trading post. He intended to build an empire.
...
The city he arrived in was quiet and conscious of its diminished status. Its streets still carried the names of French governors, admirals, and battles. Its canal still divided the Tamil quarter from the French. But the energy that had made it a capital was long gone. What remained was the grid, the stones, the sea wall, and a particular quality of light in the late afternoon that has nothing to do with politics and everything to do with where you are on the earth.`,
  },
  {
    ...
    gradient: "linear-gradient(135deg, #14532d 0%, #1a2e1a 100%)",
    photo: "the-transfer.webp",
    photoFolder: "history",
    body: `India became independent on 15 August 1947. Pondicherry did not.
...
That is perhaps the most interesting thing about Pondicherry. It absorbed the Romans and the Pallavas, the Cholas and the Mughals, the French and the British, the ashram and the commune. It remains recognisably itself. The sea that the Roman merchants sailed to reach it is the same sea you can see from the promenade today. The continuity is the city.`,
  ...
  },
  {
    ...
    title: "Two Independence Days",
    metaTitle: "Why Does Pondicherry Have Two Independence Days?",
    ...
    photoFolder: "history",
    body: `Puducherry marks Independence Day twice a year, on 15 and 16 August, and separately marks a third freedom, Liberation Day, on 1 November. Ask why, and most accounts reach straight for the tidy legal formula: a de facto transfer in 1954, a de jure transfer in 1962. That's correct, but it skips the part that actually explains why the gap between those two dates ran to eight years, and why one of Pondicherry's own leading citizens spent six years rigging elections to keep French rule in place, then switched sides overnight when the wind changed.

**Why 15 August 1947 Skipped Pondicherry**

When India became independent from Britain on 15 August 1947, Pondicherry, Karaikal, Yanam, and Mahé were not part of the handover, because they had never been British. They were French *Établissements*, governed from Paris, with their own elected assembly and, for those who held it, French citizenship. Ten days after independence, Nehru's government and France issued a joint declaration promising an amicable settlement that respected "the historical and cultural ties" linking the population to France. Three months earlier, meeting the colony's last French Governor, [Charles Baron](/history/lives-and-legacies/charles-baron), in Delhi, Nehru had already sketched the outcome he wanted: not annexation, but a Pondicherry that stayed distinctively itself inside the Indian Union. "We shall be happy," he told Baron, "to find in Pondicherry, without going far away, an open window on France." He would repeat that phrase for the next fifteen years, but he coined it in May 1947, before the difficult part had even begun.

The difficult part was that France had agreed, in principle, that the four southern enclaves should get what a fifth French territory, Chandernagore in Bengal, had already been promised: a referendum. Chandernagore held its vote on 19 June 1949, supervised by neutral observers from Denmark and El Salvador, and the result was not close: 7,473 of 7,608 voters chose India, only 114 chose France. Pondicherry, everyone assumed, would go the same way on a similar timetable. It took thirteen more years.

**The Man Who Rigged the Vote, Then Switched Sides**

The reason was a Pondicherrian doctor and political boss named [Édouard Goubert](/history/lives-and-legacies/edouard-goubert). Handed the job of organising the pro-French campaign, Goubert built a personal machine instead: in the October 1948 municipal elections his party won all 102 of 102 contested seats, a result Indian Congress observers on the ground called a farce. India seized on the fraud to declare that no fair referendum could be held under Goubert's council, and formally withdrew from the referendum agreement in 1952. The vote that might have settled the whole question quickly, cleanly, and by the population's own choice never happened, in Pondicherry or anywhere in the four southern enclaves. The genuine pro-merger movement existed regardless, built less in the rigged council chamber than on the factory floor: the communist organiser [V. Subbiah](/history/lives-and-legacies/v-subbiah) spent these same years building support for union with India among Pondicherry's textile workers, a popular base Goubert's machine could intimidate but never fully absorb.

Goubert ran Pondicherry as a personal fief for six more years, propped up by a free-port economy built on gold and diamond smuggling after the Indo-French customs union lapsed in 1949 — India's own embassy estimated fifteen tonnes of gold a year moving through the enclave. Then, in March 1954, the French governor indicted him for tax fraud. Goubert fled across the border on the night of 25–26 March, and seven weeks later announced a "liberation government" from Indian soil, campaigning for the very merger he had spent six years blocking. The single obstacle that had kept Pondicherry French for half a decade removed itself, for entirely unromantic reasons, inside eight weeks.

**Why Did France Actually Let Go?**

Goubert's defection mattered because Paris, by 1954, had almost no capacity left to resist anyway. Under the Treaty of Paris of 1814, which had restored the enclaves to France after the Napoleonic Wars, France was barred from defending them with anything more than police — there was, legally, no possibility of holding Pondicherry by force even had a government wanted to. Then, on 7 May 1954, the French garrison at Dien Bien Phu fell to the Viet Minh. The Laniel government collapsed a month later, and Pierre Mendès France took power on a promise to end France's Asian wars — which meant reaching a settlement at Geneva, which meant needing India's cooperation as a non-aligned broker. Within a week of the Geneva agreement on Indochina in July 1954, France's negotiator sent Nehru the Ostrorog memorandum: Paris would accept a rapid, purely administrative transfer ahead of any formal legal cession, and warned that without an accord within three months, France would evacuate Pondicherry and Karaikal outright. Nehru accepted within a week. Pondicherry's transfer, in other words, was settled largely as a side effect of the peace conference that ended the French war in Vietnam.

**The Congress at the Border**

The mechanism France and India agreed on was not a referendum but a congress of elected representatives, assembled at Kizhour on 18 October 1954. The hall is said to have been built straddling the Franco-Indian boundary line itself, so that delegates under outstanding French arrest warrants could sit on the Indian side of the room and vote without being seized. The result was 170 votes for merger with India, 8 against — a resolution, not a plebiscite, but the closest thing to a popular verdict French Pondicherry ever produced.

**1 November 1954: The Day the Flag Came Down**

Two weeks later, on 1 November 1954, French administrators formally handed power to a provisional government under a 35-article accord, signed for the two governments by Pierre Landy and [Kewal Singh](/history/lives-and-legacies/kewal-singh). The French tricolour came down over the Hôtel de Ville; the Indian tricolour went up. Article 28 of the accord guaranteed continued rights for the French language. This is what Puducherry now marks as [Liberation Day, or De Facto Day](/festivals/liberation-day). It was the day administration changed hands. It was not, in international law, the day Pondicherry became Indian. For the fuller account of how the negotiations reached this point, see [1954: The Handover](/history/the-handover-1954).

**16 August 1962: The Day It Became Legal**

France remained the legal sovereign of Pondicherry for almost eight more years. The Treaty of Cession was signed on 28 May 1956, and India ratified it within forty-eight hours. The French National Assembly did not. Ratification stalled for six years, partly because the Algerian War consumed nearly all French parliamentary attention between 1954 and 1962, and partly because [Charles de Gaulle](/history/lives-and-legacies/charles-de-gaulle) himself was in no hurry. Meeting Nehru in Paris in May 1960, de Gaulle said plainly that France would honour the treaty but would "prefer that its ratification not be pressed for" until Franco-Indian cultural ties, centred on the new Institut Français in Pondicherry, had visibly matured. Nehru, characteristically patient, let the matter rest. Only after the Évian Accords ended the Algerian war in March 1962 did France's parliament have room to ratify anything else — and by then India had run out of patience with slower methods elsewhere. In December 1961, Indian troops had simply seized Portuguese Goa by force, making French Pondicherry, for a few months, the only foreign-held enclave left on Indian soil that hadn't been taken at gunpoint. France ratified the treaty in July 1962, and the instruments of ratification were formally exchanged on 16 August 1962 — De Jure Day, the moment Pondicherry actually became, in law, part of India.

**So, Two Days, or Three?**

Locals compress "two Independence Days" out of 15 and 16 August, back to back on the calendar: India's own Independence Day, and Pondicherry's own De Jure Day the following morning, both now folded into the three-day [Fête de Pondichéry](/festivals/fete-de-pondichery). But that leaves out 1 November, sitting alone on the calendar, and it is genuinely the odd one out: not an independence day in the strict sense at all, but Liberation Day, the anniversary of the moment power actually changed hands, eight years before the paperwork agreed. Chandernagore shows what the alternative looked like: an earlier, tidier transfer in 1950–52 with no such gap, after which it simply dissolved into West Bengal and lost any distinct identity. Pondicherry's messier, slower path is exactly what left it a Union Territory in its own right rather than a forgotten suburb of Chennai — and exactly why it now marks not two independence days, but three, spread across two different kinds of freedom: the day the flag changed, and the day the law finally agreed.`,
    faq: [
      { question: "Why does Pondicherry have two Independence Days?", answer: "Because 15 August, India's national Independence Day, falls the day before 16 August, De Jure Day, the anniversary of 1962, when France's National Assembly finally ratified the Treaty of Cession and legal sovereignty passed to India. Locals often lump the two together as Pondicherry's 'two Independence Days.' Strictly, there is a third: 1 November, Liberation Day, marking the earlier 1954 transfer of administration." },
      { question: "Why did France give up Pondicherry?", answer: "A combination of factors converged in 1954: [Édouard Goubert](/history/lives-and-legacies/edouard-goubert), the political boss who had rigged elections for six years to keep Pondicherry French, was indicted for tax fraud and defected to the Indian side; France's garrison fell at Dien Bien Phu, and the incoming Mendès France government needed Indian diplomatic cooperation to secure peace at Geneva; and the 1814 Treaty of Paris had in any case barred France from defending the enclaves militarily." },
      { question: "When did Pondicherry stop being French?", answer: "In two stages. France handed over administration on 1 November 1954, the de facto transfer, now marked as Liberation Day. But Pondicherry remained French territory under international law until 16 August 1962, De Jure Day, when France's National Assembly finally ratified the Treaty of Cession after six years of delay caused partly by the Algerian War and partly by [Charles de Gaulle](/history/lives-and-legacies/charles-de-gaulle)'s own reluctance to rush it." },
      { question: "Who was Édouard Goubert?", answer: "The Pondicherrian political boss chosen to lead the pro-French campaign, who instead built a personal machine, winning a fraudulent 102 of 102 seats in the 1948 municipal election. India used that fraud as grounds to withdraw from an agreed referendum. Indicted for tax fraud in March 1954, Goubert fled to Indian territory and, weeks later, led a 'liberation government' campaigning for the merger he had spent six years blocking." },
      { question: "Is Pondicherry still connected to France today?", answer: "Yes. Residents who chose French citizenship at the 1962 transfer, and their descendants, still hold it. A French Consulate General operates on Rue de la Marine, and institutions such as the [Lycée Français](/history/institutions/lycee-francais) and the [Alliance Française](/history/institutions/alliance-francaise) continue to run in the city, alongside the French War Memorial that France still maintains on Goubert Avenue." },
    ],
  },
  {
    id: "les-combattants",
...
export function getHistoryArticle(id: string): HistoryArticle | undefined {
  return historyArticles.find((a) => a.id === id);
}

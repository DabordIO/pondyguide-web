...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: buildOpenGraph({ path: `/fr/history/institutions/${slug}`, image: en.photo ? `/${en.photoFolder ?? "history"}/${en.photo}` : undefined, locale: "fr_FR" }),
    alternates: {
      canonical: `/fr/history/institutions/${slug}`,
      languages: {

...
function GuideCard({ title, slug, photos, span }: { title: string; slug: string; photos: string[]; span: number }) {
  ...
  return (
    <Link href={`/hotels/guides/${slug}`} className="guide-card" style={{ gridColumn: `span ${span}`, textDecoration: "none", background: "#fff", border: "1px solid #e8ddd4", borderRadius: 14, overflow: "hidden", display: "flex", flexDirection: "column", height: "100%", minHeight: 180 }}>
